...
def run_server(port: int, outdir: str, ipv6: bool) -> None:
    ...
    # TODO: write your code here.
    serversock = socket.socket(family, socket.SOCK_STREAM)
    serversock.bind((bind_addr, port))
    serversock.listen(5)
...
def run_client(server_ip: str, port: int, file_path: str, ipv6: bool) -> int:
    ...
    # TODO: write your code here.
    clientsock = socket.socket(family, socket.SOCK_STREAM)
    clientsock.connect(addr)
    clientsock.sendall(filename.encode() + b'\n')

    # Server Response Handling
    servresponse = recv_line(clientsock)
    if servresponse != b'OK':
        return 1
